...
class I18nDOM {
  ...
  getMacroContent(text) {
    ...
    let startIndex =
      ((_a = matchedMacro[0]) === null || _a === void 0 ? void 0 : _a.index) ||
      -1;
    if (isIgnore) {
      startIndex =
        ((_b = matchedMacro[0]) === null || _b === void 0 ? void 0 : _b.index) >
        matchedIgnore.index
          ? matchedIgnore.index
          : (_c = matchedMacro[0]) === null || _c === void 0
          ? void 0
          : _c.index;
    }
    let matchedData = [];
  ...
  clearMacroInfo(text) {
    ...
    const macroStartIndex =
      (_a = text.match(hasMacroRegex)) === null || _a === void 0
        ? void 0
        : _a.index;
